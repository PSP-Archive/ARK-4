...
<p>
  ...
  - Follow these instructions to install `PBOOT.PBP` from `Vita/Standalone` to the loader generated by ChovySign: https://github.com/TheOfficialFloW/Trinity#installation
  - Install the ARK savedata folder into `/Documents/PS Vita/PSAVEDATA/xxxxxxxxxxxxxxxx/`.
