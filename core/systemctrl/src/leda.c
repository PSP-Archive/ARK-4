...
{
	SceUID (* sceKernelLoadModuleMs2_k)() = FindFunction("sceModuleManager", "ModuleMgrForKernel", 0x7BD53193);
...
int SystemCtrlForKernel_07232EA5(void *func)
{
	...
	u32 import = init_addr+0x1C64; //sctrlHENFindImport(mod, "ModuleMgrForKernel", 0x7BD53193);
