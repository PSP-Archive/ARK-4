...
# define PICKER_TITLE_COLOR       GRAY_COLOR
# define PICKER_SELECTION_COLOR   0x00CDCD00
# define PICKER_TEXT_COLOR        GRAY_COLOR
      ...
      if (bRedraw) {
        ...
        for (i = 0; i < pickerP->pick_count; i++)
        {
          ...
          if (i == iPick)
          {
            ...
            common::printText(0, Y_PICK(i), STR_PICK, text_color);
          }
          common::printText(X_PICK, Y_PICK(i), pickP->szBig, text_color);
          common::printText(X_PICK + 2, Y_PICK(i) + 1, pickP->szFinePrint, text_color);
        }
        bRedraw = 0;
        common::flipScreen();
      }
