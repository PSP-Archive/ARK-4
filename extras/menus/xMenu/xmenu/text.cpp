...
void TextAnim::draw(float y){
	...
	//intraFontSetStyle(common::getFont(), 0.7f, LITEGRAY, RED, (0xFF<<24)+(val<<16)+(val<<8)+(val),0);
	intraFontSetStyle(common::getFont(), 0.7f, LITEGRAY, RED, 0.1f,0);
	intraFontPrint(common::getFont(), 200, y+30, this->glowText.c_str());

	intraFontSetStyle(common::getFont(), 0.5f, WHITE, DARKGRAY, INTRAFONT_SCROLL_LEFT, 0);
