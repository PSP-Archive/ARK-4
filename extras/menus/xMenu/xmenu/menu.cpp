...
void Menu::initEbootList(){
	...
	while ((dit = readdir(dir))){
		...
		if (common::fileExists(string("ms0:/PSP/APPS/")+string(dit->d_name))) continue;
...
string Menu::fullPath(string app){
	...
	else if (common::fileExists("ms0:/PSP/APPS/"+app+"/FBOOT.PBP"))
		return "ms0:/PSP/APPS/"+app+"/FBOOT.PBP";

	else if (common::fileExists("ms0:/PSP/GAME/"+app+"/EBOOT.PBP"))
		return "ms0:/PSP/GAME/"+app+"/EBOOT.PBP";

	else if (common::fileExists("ms0:/PSP/APPS/"+app+"/EBOOT.PBP"))
		return "ms0:/PSP/APPS/"+app+"/EBOOT.PBP";
	
	else if (common::fileExists("ms0:/PSP/GAME/"+app+"/VBOOT.PBP"))
		return "ms0:/PSP/GAME/"+app+"/VBOOT.PBP";

	else if (common::fileExists("ms0:/PSP/APPS/"+app+"/VBOOT.PBP"))
		return "ms0:/PSP/APPS/"+app+"/VBOOT.PBP";
